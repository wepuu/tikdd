...
const copy = {
  en: {
    ...
    hero: {
      badge: "TikTok supported · X, Instagram, Facebook & Pinterest Public Beta",
      lead: "Download ", accent: "public videos", tail: " from X, Instagram, TikTok, Facebook & Pinterest",
      description: "Paste a public X post, Instagram Reel, Instagram post, TikTok video, Facebook Reel, or Pinterest Pin URL. TikDD resolves the available formats and creates a short-lived download link."
    },
    form: {
      label: "Public video page URL",
      placeholder: "Paste an x.com, instagram.com, tiktok.com, facebook.com, or pinterest.com URL",
      ...
      retryableTitle: "Temporarily unavailable", retryableDescription: "TikDD could not finish this request yet. Try the same link again shortly.", retryAction: "Try again", resolveAgainAction: "Resolve again",
    ...
    features: [
      ["TikTok supported · X, Instagram, Facebook & Pinterest Public Beta", "Recognizes public x.com, instagram.com, tiktok.com, facebook.com, and pinterest.com video URLs."],
    ...
    supported: { label: "Supported:", platforms: ["X", "Instagram", "TikTok", "Facebook", "Pinterest"] },
    process: {
      title: "How it works",
      steps: [
    ...
    faq: {
      ...
      items: [
        ["Which links can I use?", "TikDD accepts public x.com and twitter.com posts, public Instagram Reels or posts, public TikTok video pages, public Facebook Reels, and public Pinterest Pins. TikTok is a stable supported route; X, Instagram, Facebook, and Pinterest remain in public Beta."],
    ...
    legal: "TikDD is an independent tool and is not affiliated with X, Instagram, TikTok, Facebook, or Pinterest."
  },
  "zh-CN": {
    nav: { home: "首页", features: "功能", process: "工作方式", supported: "支持的平台", faq: "常见问题", language: "English" },
    hero: {
      badge: "TikTok 已支持 · X、Instagram、Facebook 与 Pinterest 公开测试",
      lead: "从 X、Instagram、TikTok、Facebook 与 Pinterest 下载", accent: "公开视频", tail: "",
      description: "粘贴公开的 X 帖子、Instagram Reel、Instagram 帖子、TikTok 视频、Facebook Reel 或 Pinterest Pin 链接，TikDD 会解析可用格式并生成短期下载链接。"
    },
    form: {
      label: "公开视频页面链接", placeholder: "粘贴 x.com、instagram.com、tiktok.com、facebook.com 或 pinterest.com 链接",
      ...
      retryableTitle: "暂时无法完成", retryableDescription: "TikDD 暂时未能完成本次请求，请稍后使用同一链接重试。", retryAction: "重试", resolveAgainAction: "重新解析",
    ...
    features: [
      ["TikTok 已支持 · X、Instagram、Facebook 与 Pinterest 公开测试", "识别公开的 x.com、instagram.com、tiktok.com、facebook.com 和 pinterest.com 视频链接。"],
      ["格式清晰", "将清晰度和媒体信息统一为一致的选择界面。"],
      ["受控交付", "使用短期交付链接，不公开上游媒体地址。"]
    ],
    supported: { label: "支持的平台：", platforms: ["X", "Instagram", "TikTok", "Facebook", "Pinterest"] },
    process: {
      title: "工作方式",
      steps: [
    ...
    faq: {
      title: "常见问题",
      items: [
        ["可以使用哪些链接？", "TikDD 支持公开的 X 帖子、公开的 Instagram Reel 或帖子、TikTok 视频页面、Facebook Reel 以及 Pinterest Pin 链接。TikTok 已稳定支持，X、Instagram、Facebook 与 Pinterest 仍处于公开测试。"],
    ...
    legal: "TikDD 是独立工具，与 X、Instagram、TikTok、Facebook 或 Pinterest 不存在隶属关系。"
  }
} as const;
