...
const copy = {
  en: {
    ...
    form: {
      ...
      recognized: "link recognized", resolving: "Resolving available formats", ready: "Formats ready",
  ...
  "zh-CN": {
    ...
    form: {
      ...
      waiting: "等待支持的公开视频链接", recognized: "链接已识别", resolving: "正在解析可用格式", ready: "格式已就绪",
