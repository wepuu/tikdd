...
const copy = {
  en: {
    ...
    form: {
      ...
      deliveryReady: "Your short-lived download link is ready. It opens in a new tab.", startDownload: "Start download",
      deliveryHandedOff: "Download handed to your browser in a new tab. If it did not start, create a new link.",
  ...
  "zh-CN": {
    ...
    form: {
      ...
      deliveryReady: "短期下载链接已准备好，将在新标签页中打开。", startDownload: "开始下载",
      deliveryHandedOff: "已在新标签页中交给浏览器下载。如未开始，请创建新链接。",
