...
const copy = {
  en: {
    ...
    form: {
      ...
      deliveryReady: "Your short-lived download link is ready. It opens in a new tab and downloads directly from the media host.", startDownload: "Start download",
      deliveryHandedOff: "Download handed to your browser in a new tab. The browser or media host may choose the final filename. If it did not start, create a new link.",
  ...
  "zh-CN": {
    ...
    form: {
      ...
      deliveryReady: "短期下载链接已准备好，将在新标签页打开，并由浏览器直接从媒体主机下载。", startDownload: "开始下载",
      deliveryHandedOff: "已在新标签页中交给浏览器下载。最终文件名可能由浏览器或媒体主机决定。如未开始，请创建新链接。",
