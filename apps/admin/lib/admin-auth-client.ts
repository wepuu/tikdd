...
function connection(){const origin=process.env.ADMIN_API_INTERNAL_ORIGIN??"http://127.0.0.1:4100";const admin=process.env.ADMIN_ORIGIN??"http://localhost:3001";return{origin,admin,proof:process.env.ADMIN_ORIGIN_PROOF?.trim()||null};}
