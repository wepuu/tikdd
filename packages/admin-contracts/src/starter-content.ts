...
const shared = (locale: StarterLocale): AdminSharedContent => AdminSharedContentSchema.parse(
  locale === "en"
    ? {
        ...
        defaultSocialTitle: "TikDD X, Instagram, and TikTok video downloader Beta",
    ...
    : {
        ...
        defaultSocialTitle: "TikDD X、Instagram 与 TikTok 视频下载 Beta",
...
const homepageContent = (locale: StarterLocale): AdminPageContent => AdminPageContentSchema.parse(
  locale === "en"
    ? {
        ...
        supportedPlatformsTitle: "X, Instagram & TikTok Public Beta",
        ...
        faqItems: [
          { question: "Which links can I use?", answerMarkdown: "The current Beta accepts public X posts, Instagram Reels or posts, and TikTok video pages." },
    ...
    : {
        ...
        supportedPlatformsTitle: "X、Instagram 与 TikTok 公开 Beta",
        ...
        faqTitle: "常见问题",
        faqItems: [
          { question: "可以使用哪些链接？", answerMarkdown: "当前 Beta 接受公开的 X 帖子、Instagram Reel 或帖子，以及 TikTok 视频页面链接。" },
      ...
      geo: {
        directAnswer: platform === "x"
          ...
          : platform === "instagram"
            ...
            : "TikDD's TikTok Beta accepts public TikTok video links and can return a short-lived MP4 download link when the public page is accessible.",
        reviewStatus: "draft",
        reviewedAt: null,
    ...
    geo: {
      directAnswer: platform === "x"
        ...
        : platform === "instagram"
          ...
          : "TikDD TikTok Beta 支持公开的 TikTok 视频链接；当公开页面可访问时，可返回短期有效的 MP4 下载链接。",
      reviewStatus: "draft",
      reviewedAt: null,
      sourceRefs: ["tikdd-workflow", platform === "x" ? "x-public-content" : platform === "instagram" ? "instagram-public-content" : "tiktok-public-content"]
    }
...
const faqContent = (locale: StarterLocale): AdminPageContent => AdminPageContentSchema.parse(
  locale === "en"
    ? {
        ...
        introduction: "A short guide to TikDD's public X, Instagram, and TikTok Beta workflow.",
        items: [
          { question: "What does TikDD support?", answerMarkdown: "The public Beta accepts public X posts, Instagram Reels or posts, and TikTok video pages." },
    ...
    : {
        template: "faq",
        title: "常见问题",
        introduction: "这里介绍 TikDD 公开 X、Instagram 与 TikTok Beta 的使用方式。",
        items: [
          { question: "TikDD 支持什么？", answerMarkdown: "公开 Beta 接受公开的 X 帖子、Instagram Reel 或帖子，以及 TikTok 视频页面。" },
...
const seo = (locale: StarterLocale, page: "home" | "x" | "instagram" | "tiktok" | "faq" | "help" | "privacy" | "terms"): AdminSeoFields => {
  const labels = locale === "en"
    ? { home: "TikDD X, Instagram, and TikTok video downloader Beta", x: "TikDD X video downloader Beta", instagram: "TikDD Instagram video downloader Beta", tiktok: "TikDD TikTok video downloader Beta", faq: "TikDD frequently asked questions", help: "How to use TikDD", privacy: "TikDD privacy", terms: "TikDD terms of use" }
    : { home: "TikDD X、Instagram 与 TikTok 视频下载 Beta", x: "TikDD X 视频下载 Beta", instagram: "TikDD Instagram 视频下载 Beta", tiktok: "TikDD TikTok 视频下载 Beta", faq: "TikDD 常见问题", help: "如何使用 TikDD", privacy: "TikDD 隐私说明", terms: "TikDD 使用条款" };
