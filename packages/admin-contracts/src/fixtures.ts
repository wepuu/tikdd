...
export const ADMIN_BETA_HEALTH_FIXTURE: AdminBetaHealth = {
  ...
  latestEventAt: "2026-08-11T11:59:00.000Z",
  totals: betaBucket,
  byPlatform: { x: betaBucket, instagram: { ...betaBucket, latestEventAt: "2026-08-11T11:48:00.000Z", tasks: { ...betaBucket.tasks, total: 20, succeeded: 16 }, attempts: { ...betaBucket.attempts, total: 22, succeeded: 18 }, deliveries: { ...betaBucket.deliveries, total: 18, succeeded: 17 } }, tiktok: { ...betaBucket, latestEventAt: "2026-08-11T11:42:00.000Z", tasks: { ...betaBucket.tasks, total: 12, succeeded: 9 }, attempts: { ...betaBucket.attempts, total: 14, succeeded: 10 }, deliveries: { ...betaBucket.deliveries, total: 10, succeeded: 9 } }, facebook: { ...betaBucket, latestEventAt: "2026-08-11T11:36:00.000Z", tasks: { ...betaBucket.tasks, total: 8, succeeded: 7 }, attempts: { ...betaBucket.attempts, total: 9, succeeded: 8 }, deliveries: { ...betaBucket.deliveries, total: 8, succeeded: 8 } } }
};
...
export const ADMIN_ROUTE_POLICY_FIXTURE: AdminRoutePolicyRevision = {
  ...
  trafficShares: [{ providerId: "twittersaver", shareBps: 10_000 }],
