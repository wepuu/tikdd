...
export const FREE_PROVIDER_PORTFOLIO: readonly FreeProviderCandidate[] = [
  ...
  {
    id: "savevideo-me",
    displayName: "SaveVideo.me",
    platforms: ["dailymotion", "facebook", "vimeo", "x", "instagram", "tiktok", "reddit", "rumble"],
    freeAccess: true,
    publicContentOnly: true,
    requiresLogin: false,
    requiresCookies: false,
  ...
  },
  {
    ...
    platforms: ["instagram", "facebook", "x", "tiktok", "vimeo"],
    freeAccess: true,
    publicContentOnly: true,
    requiresLogin: false,
    requiresCookies: false,
  ...
  {
    id: "downbot-app",
    displayName: "DownBot.app",
    platforms: ["youtube", "tiktok", "facebook", "instagram", "vimeo", "x"],
    freeAccess: true,
    publicContentOnly: true,
    requiresLogin: false,
    requiresCookies: false,
